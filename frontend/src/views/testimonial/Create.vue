        ...
        <b-container>
            <b-row>
                <b-col cols="12">
                    ...
                    >
                        <b-card-actions
                            ref="createTestimonial"
                            title="Create Testimonial"
                            action-collapse
                        >
                            <validation-observer
                                ref="createTestimonialForm"
                                v-slot="{ handleSubmit }"
                            >
                                <b-form @submit.prevent="handleSubmit(createTestimonial)">
                                    <b-row>
                                        <!-- Photo -->
                                        <b-col
                                            lg="6"
...
export default {
    ...
    methods: {
        ...
        createTestimonial() {
            ...
            this.$store.dispatch('testimonial/create', data).then(response => {
                ...
                this.$refs.createTestimonialForm.setErrors(error.response.data.errors)
                this.testimonial.isLoading = false
            })
        },
        reset() {
            this.testimonial.form.client_name = ''
            this.testimonial.form.feedback_en = ''
            this.testimonial.form.feedback_fr = ''
            this.testimonial.form.site_id = null
            this.testimonial.form.photo = null
        },
    },
}
</script>
