                    ...
                    >
                        <b-row>
                            ...
                            <b-col
                                ...
                                class="mb-1"
                            >
                                <router-link :to="`/sites/${slider.data.site.id}`">{{slider.data.site.name}}</router-link>
                            </b-col>
                            <b-col
                                cols="4"
                                lg="2"
