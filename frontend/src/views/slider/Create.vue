                    ...
                    >
                        ...
                        >
                            <validation-observer
                                ...
                                v-slot="{ handleSubmit }"
                            >
                                <b-form @submit.prevent="handleSubmit(createSlider)">
                                    <b-row>
                                        <!-- Photo -->
                                        <b-col
                                            lg="6"
    ...
    methods: {
        ...
        createSlider() {
            ...
            Object.keys(this.slider.form).forEach(key => {
                data.append(key, this.slider.form[key])
            })
            this.$store.dispatch('slider/create', data).then(response => {
        ...
        reset() {
            this.slider.form.main_title_en = ''
            this.slider.form.main_title_fr = ''
            this.slider.form.sub_title_en = ''
            this.slider.form.sub_title_fr = ''
            this.slider.form.button_url = ''
            this.slider.form.site_id = null
            this.slider.form.photo = null
        },
    },
}
</script>
