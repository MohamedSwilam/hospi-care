                    ...
                    >
                        ...
                        >
                            <validation-observer
                                ...
                                v-slot="{ handleSubmit }"
                            >
                                <b-form @submit.prevent="handleSubmit(createCategory)">
                                    <b-row>
                                        <!-- Photo -->
                                        <b-col
                                            lg="6"
...
export default {
    ...
    methods: {
        ...
        createCategory() {
            ...
            this.$store.dispatch('category/create', data).then(response => {
                ...
                this.$refs.createCategoryForm.setErrors(error.response.data.errors)
                this.category.isLoading = false
            })
        },
        reset() {
            this.category.form.name_en = ''
            this.category.form.name_fr = ''
            this.category.form.photo = null
            this.category.form.site_id = null
        },
    },
}
</script>
